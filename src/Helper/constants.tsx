...
export {emailRegex, validNumberRegex, numberOnlyRegex, ageRatings, myAgeRatingSelect, myGenresSelect, myGenres, settings,
    nameRegex, letterAndNumberOnlyRegex, runtimeRegex, passwordRegex, sortOptions, sortOptionDic, sortDirectionDic, settingsSimilar, APIUrl, APIKey}
